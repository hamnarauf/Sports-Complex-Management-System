 ...
 * @author Hamna Rauf
 */
public class RemoveEmpController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(RemoveEmpController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void loadData() throws SQLException, ClassNotFoundException {
        ...
        allEmployee = DbQuery.displayDelEmp();
